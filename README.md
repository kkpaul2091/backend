...
git init
git add .
git commit  -m "Backend Commit initiated at: $(date '+ %A, %B %d, %Y at %I:%M %p')"
git branch -M main
git remote add origin https://kkpaul2091@kgithub.com/kkpaul2091/backend.git
git remote set-url origin https://kkpaul2091@github.com/kkpaul2091/backend.git
